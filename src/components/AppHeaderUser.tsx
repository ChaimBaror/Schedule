        ...
        <div className="text-blue-500 ml-auto flex gap-4">
            <RestrictedContent fallback={<Link className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-1 px-2 rounded ml-auto text-sm" href="/signin">Sign In</Link>}>
                ...
                >
                    ...
                    <span className="avatar h-12 w-12 rounded-full">
                        <Image
                            width={112}
                            height={112}
                            src={"/assets/logo.png"}
                ...
                <div
                    ...
                    <ul className="bg-black text-white flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                    ...
                    <button onClick={handleSignOut} className="bg-red-500 hover:bg-red-600 text-white flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                        <svg
                            className="fill-current"
                            width="22"
                            height="22"
